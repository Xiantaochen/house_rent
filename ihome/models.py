...
class BaseModel(object):
    ...
    create_time = db.Column(db.DateTime, default=datetime.now) #纪录创建的时间
    update_time = db.Column(db.DateTime, default=datetime.now, onupdate=datetime.now) #纪录的更新时间
...
class House(BaseModel, db.Model):
    ...
    #         'id': self.id,
    #         'title': self.title,
    #         'image': constant.QINIU_DOMIN_PREFIX + self.index_image_url if self.index_image_url else '',
    #         'area': self.area.name,
    #         'price': self.price,
    #         'create_time': self.create_time.strftime('%Y-%m-%d %H:%M:%S'),
    #         'avatar': constant.QINIU_DOMIN_PREFIX + self.user.avatar if self.user.avatar else '',
    ...
    #     return {
    #         'id': self.id,
    #         'user_avatar': constant.QINIU_DOMIN_PREFIX + self.user.avatar if self.user.avatar else '',
    ...
    #         'order_count': self.order_count,
    #         'images': [constant.QINIU_DOMIN_PREFIX + image.url for image in self.images],
